...
scroll_addclass(obj_fixed,class_name,value){ //滚动条到一定的时候加上类名
...
moveTop(down_obj,obj_Width,out_obj) //拖动弹窗
...
function scroll_addclass(obj_fixed,class_name,value){ //滚动条到一定的时候加上类名
...
function table(left_obj,right_obj,ife){ //表格js
